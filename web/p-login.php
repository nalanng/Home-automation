...
<body>
       ...
       if ($_SERVER["REQUEST_METHOD"] == "POST") {
           ...
           if(!(empty($_POST["id"])) && !(empty($_POST["password"]))){
            if($_POST["id"]=="20200808040" && $_POST["password"]=="123456") {
                header("location:producer-search-screen.html");
                exit();
            }
            else {
    ...
    <header>
        <nav>
        <!-- Click on the logo to go to the homepage. -->
        ...
        <div class="producer-login">
            ...
            <div class="content">
                ...
                <div class="login1">
                    ...
                    <form method="POST" >
                    <input type="text" placeholder="Enter producer ID" name="id" value="<?php echo $id;?>">
